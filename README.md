...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-rebus.base-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2366&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rebus.base-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rebus.base` can be installed with:

```
conda install r-rebus.base
```

It is possible to list all of the versions of `r-rebus.base` available on your platform with:
